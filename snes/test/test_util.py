...
class TestFramebufferDecoding(unittest.TestCase):
	...
	def test_pixel_decoding(self):
		"""
		util._decode_pixel() converts SNES XRGB1555 pixels to RGBX8888 format.
		"""
		testdata = {
				0x0000: "\x00\x00\x00\x00",
				0x001F: "\x00\x00\xff\x00",
				0x03E0: "\x00\xff\x00\x00",
				0x7C00: "\xff\x00\x00\x00",
				0x8000: "\x00\x00\x00\x00",
				0x7FFF: "\xff\xff\xff\x00",
				0xFFFF: "\xff\xff\xff\x00",
			}
	...
	def test_frame_decoding(self):
		"""
		snes_framebuffer_to_RGBX8888 converts SNES video frames to RGBX8888.
		"""
		snes_frame = [
		...
		actual_frame = util.snes_framebuffer_to_RGBX8888(snes_frame, 2, 2, 2)

		self.assertEqual(actual_frame, expected_frame)

	def test_frame_decoding_with_pitch(self):
		"""
		snes_framebuffer_to_RGBX8888 converts frames with padding on the right.
		"""
		snes_frame = [
		...
		actual_frame = util.snes_framebuffer_to_RGBX8888(snes_frame, 2, 2, 4)
